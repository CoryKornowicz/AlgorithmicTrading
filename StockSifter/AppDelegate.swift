...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let tabBarController : UITabBarController = {
            let temp = UITabBarController()
            temp.tabBar.tintColor = .black
            temp.tabBar.isTranslucent = false
            temp.tabBar.barTintColor = .white
            return temp
        }()
        ...
        let setView = SettingsController()
        
        nav2.viewControllers = [setView]
        nav2.tabBarItem = UITabBarItem.init(title: "Settings", image: nil, tag: 1)
